...
function JingDongGetCash(s) {
  ...
  return new Promise(resolve => {
    ...
    setTimeout(() => {
      const GetCashUrl = {
        url: 'https://api.m.jd.com/client.action?functionId=cash_getRedPacket&body=%7B%22type%22%3A%222%22%2C%22amount%22%3A%221000%22%7D&client=apple&clientVersion=9.3.2&openudid=5675c7df49de13aeca1e98def1d789a3cf4c84a6&sign=af35b469662cad4c11271172dad50886&st=1609828730430&sv=121',
        headers: {
          Cookie: KEY,
        }
      };
